...
<form class="course-form-area contact-page-form course-form text-right" id="myForm" action="https://preview.colorlib.com/theme/eclipse/mail.html" method="post" style="margin-top: 25px;">
