...
//        }
    ...
    $sql="select e.* ,c.name as course_name, u.name as user_name from courses c, users u , enrolled e where e.course_id=c.id and e.u_id=u.id";
...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php
            if(isset($resEnrolled))
            {
        ?>
                <div class="alert alert-success"><strong>Success! </strong> your request successfully updated. </div> 
        <?php
            }
            else if(isset($errorEnrolled))
            {
        ?>
                <div class="alert alert-danger"><strong>Error! </strong><?=$errorEnrolled?></div> 
        <?php
                ...
                <table id="example1" class="table table-bordered table-hover">
                    <thead>
                     ...
                     <?php
                            ...
                            if (isset($enrolledList)) 
                            {
                                $i = 1;
                                foreach ($enrolledList as $detail) 
                                {    
